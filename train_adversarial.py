...
def train():
    ...
    for step in range(MAX_STEPS):
        ...
        loss_rec_ent = F.relu(dist_pos_ent - dist_neg_ent + 0.1).mean()
        ...
        loss_rec_rel = F.relu(dist_pos_rel - dist_neg_rel + 0.1).mean()
        ...
        if step % 10 == 0 or step == MAX_STEPS - 1:
            ...
            with torch.no_grad():
                ...
                ema_rec_ent = F.relu(ema_dist_pos_ent - ema_dist_neg_ent + 0.1).mean()
                ...
                ema_rec_rel = F.relu(ema_dist_pos_rel - ema_dist_neg_rel + 0.1).mean()
